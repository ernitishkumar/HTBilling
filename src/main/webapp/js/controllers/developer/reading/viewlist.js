angular.module("htBillingApp").controller('ListDeveloperReadingsController', ['$http', '$scope', '$location', '$routeParams','authService','utilService','localStorageService', function ($http, $scope, $location, $routeParams, authService,utilService,localStorageService) {
	...
	function loadReadings() {
		$scope.loading = true;
		console.log("getting data for Developer "+$scope.userRole);
		$http(
				{
					method: 'GET',
					url: 'backend/readings/developer/month/'+$scope.formData.billMonth,
					params: {
	...
	$scope.pageChangeHandler = function(num) {
	  ...
	  $scope.billMonthYearChanged = function(){
		...
		$scope.exportReadings = function () {
	        ...
	        var fileUrl;
			fileUrl = window.location.origin+"/htbilling/backend/export/developer/month/"+$scope.formData.billMonth;
