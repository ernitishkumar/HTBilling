angular.module("htBillingApp").controller('ConsumptionReportCtrl', ['$http', '$scope', '$location','authService', function ($http, $scope, $location,authService) {
